...
def sign(df_cookie, ns_random):
    ...
    try:
        url = f"https://www.deepflood.com/api/attendance?random={ns_random}"
...
# ---------------- 查询签到收益统计函数 ----------------
def get_signin_stats(df_cookie, days=30):
    """查询前days天内的签到收益统计"""
    if not df_cookie:
